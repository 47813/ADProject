...
function VideoSortedByTitle() {
  const [videos, setVideos] = useState([]);

  useEffect(() => {
    axios.get('http://localhost:8000/videos/sorted/title/')
    ...
    <div className="container mt-4">
      ...
      <div className="mb-4">
        <div className="btn-group" role="group" aria-label="View Options">
          <a href="/videos/author/" className="btn btn-outline-primary px-4 py-2">저자별 보기</a>
...
export default VideoSortedByTitle;